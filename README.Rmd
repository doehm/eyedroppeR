...
5. If it's the first time you have run `eyedropper` complete the calibration setup. It only needs to be done once. Just click the top dot and then the bottom dot.

    <img src='dev/images/calibrate.png' height = 270 width = 480/>
    
    (This is a temporary step to ensure there are no issues until I find an automated way to do it.)
