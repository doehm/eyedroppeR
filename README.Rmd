...
By setting `pixelate = TRUE` the original image will be converted to a low resolution so that it's easily to select the right colour. The default pixelation is set to 40 (pixels on the x and y). You can adjust that higher or lower as needed.
